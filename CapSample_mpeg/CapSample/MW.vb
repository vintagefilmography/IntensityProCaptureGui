...
#End Region
    ...
    Public Sub RefreshImage(ByVal Frame As System.Windows.Forms.PictureBox)
        ...
        If (CaptureInformation.CounterFrames = 1) Then
            'create New AVI file And open it
            writer = New VideoFileWriter()
            writer.Open("C:\\capture\\test.mp4", 1920, 1080, 30, VideoCodec.MPEG4)
            'writer.Open("C:\\capture\\test.mp4", Width, Height, framerate, 0)
        End If
        writer.WriteVideoFrame(Frame.Image)
        'Me.pcbFrame.Image.Save(s(0) + CStr(CaptureInformation.CounterFrames) + ".tiff", System.Drawing.Imaging.ImageFormat.Tiff)
        CaptureInformation.CounterFrames += 1
        Me.pcbFrame.Refresh()
    End Sub
    ...
    Private Sub Form1_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseClick
        CaptureInformation.CaptureInfo.CaptureFrame()
    End Sub
